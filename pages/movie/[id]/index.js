  ...
  return (
    <div className="container max-w-4xl mx-auto pt-6"> 
        <div className="px-3">
            ...
            <p className="text-gray-600 text-sm">Date de sortie : <span className="font-bold">{movie.release_date}</span></p>
        </div>
    </div>
  )
}
...
export async function getStaticProps(context) {
    ...
    const res = await axios(`${server}/${id}?api_key=${process.env.TMDB_API_KEY}&language=fr&page=1`);
